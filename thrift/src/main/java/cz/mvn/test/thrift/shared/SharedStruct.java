...
public class SharedStruct implements org.apache.thrift.TBase<SharedStruct, SharedStruct._Fields>, java.io.Serializable,
		Cloneable, Comparable<SharedStruct> {
	...
	public SharedStruct(int key, String value) {
		this();
		this.key = key;
		setKeyIsSet(true);
		this.value = value;
