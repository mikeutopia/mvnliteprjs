...
public class CommCommandREQ implements org.apache.thrift.TBase<CommCommandREQ, CommCommandREQ._Fields>, java.io.Serializable, Cloneable, Comparable<CommCommandREQ> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("CommCommandREQ");
  ...
  static {
    schemes.put(StandardScheme.class, new CommCommandREQStandardSchemeFactory());
    schemes.put(TupleScheme.class, new CommCommandREQTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(CommCommandREQ.class, metaDataMap);
  }

  public CommCommandREQ() {
  }
   ...
   */
  public CommCommandREQ(CommCommandREQ other) {
  ...
  public CommCommandREQ deepCopy() {
    return new CommCommandREQ(this);
  }
  ...
  public CommCommandREQ setReqID(long reqID) {
    this.reqID = reqID;
    setReqIDIsSet(true);
    return this;
  }
  ...
  public CommCommandREQ setParameter(BaseMsg parameter) {
    this.parameter = parameter;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof CommCommandREQ)
      return this.equals((CommCommandREQ)that);
    return false;
  }

  public boolean equals(CommCommandREQ that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(CommCommandREQ other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("CommCommandREQ(");
    boolean first = true;
  ...
  private static class CommCommandREQStandardSchemeFactory implements SchemeFactory {
    public CommCommandREQStandardScheme getScheme() {
      return new CommCommandREQStandardScheme();
    }
  }

  private static class CommCommandREQStandardScheme extends StandardScheme<CommCommandREQ> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, CommCommandREQ struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CommCommandREQ struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class CommCommandREQTupleSchemeFactory implements SchemeFactory {
    public CommCommandREQTupleScheme getScheme() {
      return new CommCommandREQTupleScheme();
    }
  }

  private static class CommCommandREQTupleScheme extends TupleScheme<CommCommandREQ> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, CommCommandREQ struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, CommCommandREQ struct) throws org.apache.thrift.TException {
