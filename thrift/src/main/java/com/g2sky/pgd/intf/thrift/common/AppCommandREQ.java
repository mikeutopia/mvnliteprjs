...
public class AppCommandREQ implements org.apache.thrift.TBase<AppCommandREQ, AppCommandREQ._Fields>, java.io.Serializable, Cloneable, Comparable<AppCommandREQ> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("AppCommandREQ");
  ...
  static {
    schemes.put(StandardScheme.class, new AppCommandREQStandardSchemeFactory());
    schemes.put(TupleScheme.class, new AppCommandREQTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(AppCommandREQ.class, metaDataMap);
  }

  public AppCommandREQ() {
  }
   ...
   */
  public AppCommandREQ(AppCommandREQ other) {
    if (other.isSetReqID()) {
  ...
  public AppCommandREQ deepCopy() {
    return new AppCommandREQ(this);
  }
  ...
  public AppCommandREQ setReqID(String reqID) {
    this.reqID = reqID;
    return this;
  }
  ...
  public AppCommandREQ setParameter(BaseMsg parameter) {
    this.parameter = parameter;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof AppCommandREQ)
      return this.equals((AppCommandREQ)that);
    return false;
  }

  public boolean equals(AppCommandREQ that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(AppCommandREQ other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("AppCommandREQ(");
    boolean first = true;
  ...
  private static class AppCommandREQStandardSchemeFactory implements SchemeFactory {
    public AppCommandREQStandardScheme getScheme() {
      return new AppCommandREQStandardScheme();
    }
  }

  private static class AppCommandREQStandardScheme extends StandardScheme<AppCommandREQ> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, AppCommandREQ struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, AppCommandREQ struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class AppCommandREQTupleSchemeFactory implements SchemeFactory {
    public AppCommandREQTupleScheme getScheme() {
      return new AppCommandREQTupleScheme();
    }
  }

  private static class AppCommandREQTupleScheme extends TupleScheme<AppCommandREQ> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, AppCommandREQ struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, AppCommandREQ struct) throws org.apache.thrift.TException {
